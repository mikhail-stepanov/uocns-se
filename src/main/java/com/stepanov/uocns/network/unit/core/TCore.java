package com.stepanov.uocns.network.unit.core;

import com.stepanov.uocns.network.TNetworkManager;
import com.stepanov.uocns.network.common.IConstants;
import com.stepanov.uocns.network.common.TTypeFlit;
import com.stepanov.uocns.network.traffic.ICoreTraffic;
import com.stepanov.uocns.network.traffic.TCoreTraffic;
import com.stepanov.uocns.network.traffic.TFlit;
import com.stepanov.uocns.network.traffic.TPacket;
import com.stepanov.uocns.network.unit.core.buffer.TBufferPacketTx;
import com.stepanov.uocns.network.unit.router.IRouter;
import com.stepanov.uocns.network.unit.router.buffer.IBufferPLink;
import com.stepanov.uocns.network.unit.router.buffer.TBufferPLink;
import com.stepanov.uocns.network.unit.router.link.TPLinkTx;
